...
- `purchase.html` / `purchase.js` — public email-to-checkout flow
...
2. A website purchase creates the selected Monthly, Annual, or Lifetime transaction.
3. Paddle completion reaches `payment-complete.html`.
4. The signed webhook updates the same FluentSocial AI account.
