    ...
    pages: {
      "index.html": {
        ...
        selectors: {
          ...
          ".product-card:nth-child(1) .subtitle":
            "Chrome 扩展。为 200+ 轮超长对话自动生成目录，支持一键跳转、书签标记，导出为 Markdown 或带目录的 HTML，并可备份到你自己的 Google Drive。",
      ...
      "privacy.html": {
        ...
        selectors: {
          ...
          "main > section:nth-of-type(3) p:nth-of-type(3)":
            "<strong>导出与 Google Drive 备份：</strong>Markdown 和 HTML 导出文件均在本地生成并由你保存。如果你选择 Google Drive 备份，扩展仅使用 identity 权限让你通过自己的 Google 账号授权，并将导出的对话上传到你选择的 Google Drive 位置。身份验证由 Chrome 和 Google OAuth 处理。我们不会收集、存储、出售或分享你的身份信息，授权令牌也仅用于执行你请求的上传。",
          "main > section:nth-of-type(3) p:nth-of-type(4)":
            "为了管理订阅和许可证，我们可能会处理以下有限数据：",
          ...
          "main > section:nth-of-type(3) p:nth-of-type(5)":
            "这些数据仅用于许可证验证、计费管理和客户支持。我们不会将这些数据或你的导出内容用于广告或画像。",
      ...
      "product.html": {
        ...
        selectors: {
          ...
          ".product-card.featured-product .subtitle": "为 ChatGPT 和 Gemini 长对话自动生成可点击目录。一键跳转到任意消息、标记关键问答，导出为 Markdown 或带目录的 HTML，并可备份到你自己的 Google Drive。",
      ...
      "pricing.html": {
        ...
        selectors: {
          ...
          ".price-grid .price-card:nth-child(1) ul li:nth-child(2)":
            "<strong>书签：</strong>每会话 10 个书签",
          ".price-grid .price-card:nth-child(1) ul li:nth-child(3)":
            "<strong>导出与 Google Drive 备份：</strong>每月共 20 次操作",
          ...
          ".price-grid .price-card:nth-child(1) ul li:nth-child(5)":
            "<strong>Markdown 与 HTML 导出：</strong>HTML 支持内置目录",
          ".price-grid .price-card:nth-child(1) ul li:nth-child(6)":
            "<strong>个人云端备份：</strong>将 AI 对话保存到你自己的 Google Drive",
          ...
          ".price-grid .price-card:nth-child(2) ul li:nth-child(3)":
            "<strong>导出与 Google Drive 备份：</strong>无限制，包括 Markdown 与 HTML 导出",
      ...
      "outline-pro.html": {
        ...
        selectors: {
          ...
          ".sales-hero > p.subtitle":
            "为 ChatGPT 与 Gemini 长对话自动生成可点击目录。一键跳转到消息、标记关键问答，导出为 Markdown 或带目录的 HTML，并可备份到你自己的 Google Drive。",
          ".sales-hero .hero-actions .btn-link.primary": "安装 Chrome 插件",
          ".sales-hero .hero-actions .btn-link.secondary": "查看功能",
          ...
          "main > section#pricing .section-intro .subtitle":
            "所有套餐均支持 ChatGPT 和 Gemini 无限制目录跳转。Pro 增加无限书签、无限导出、无限 Google Drive 备份和 Inbox AI 摘要。",
          ...
          "main > section#pricing .price-card:nth-child(1) .plan-compare-list li:nth-child(2)":
            "<span class=\"plan-icon\">🟡</span><span><strong>书签：</strong>每会话 10 个书签</span>",
          "main > section#pricing .price-card:nth-child(1) .plan-compare-list li:nth-child(3)":
            "<span class=\"plan-icon\">🟠</span><span><strong>导出与 Google Drive 备份：</strong>每月共 20 次操作，包括 Markdown 与 HTML 导出</span>",
          ...
          "main > section#pricing .price-card:nth-child(2) .plan-kicker": "包含免费版全部功能，另加无限书签、无限导出、无限 Google Drive 备份与 AI 摘要。",
          ...
          "main > section#pricing .price-card:nth-child(2) .plan-compare-list li:nth-child(3)":
            "<span class=\"plan-icon\">✅</span><span><strong>导出与 Google Drive 备份：</strong>无限制，包括 Markdown 与 HTML 导出</span>",
          ...
          "main > section#pricing > p.small-note":
            "新用户可获得 7 天 Pro 试用，完整使用 Pro 的导航、书签、导出与 Google Drive 备份权益。",
          ...
          "#features .feature-item:nth-child(3) p": "标记值得保存的具体问答回合。免费用户每会话 10 个书签；Pro 用户无限制。随时回顾你的书签。",
          ...
          "#features .feature-item:nth-child(5) h3": "Markdown、HTML 与 Google Drive 备份",
          "#features .feature-item:nth-child(5) p": "将对话导出为 Markdown 或带内置目录的 HTML，也可以备份到你自己的 Google Drive。免费版和 Pro 均支持这些功能。",
          "#features .feature-item:nth-child(6) h3": "本地处理，隐私优先",
          "#features .feature-item:nth-child(6) p": "除非你主动选择 Google Drive 备份，否则页面内容只留在浏览器中。备份会直接上传到你自己的 Google Drive，而不是我们的服务器。",
          ".demo-section .section-intro h2": "观看演示",
          ".video-poster-overlay .video-poster-cta": "观看演示",
          ...
          "#faq .faq-item:nth-child(2) h3": "目录导航有限制吗？",
          "#faq .faq-item:nth-child(2) p": "没有。ChatGPT 和 Gemini 的目录导航均不限次数。",
          ...
          "#faq .faq-item:nth-child(5) p": "有。新用户可获得 7 天 Pro 试用，完整使用 Pro 的导航、书签、导出与 Google Drive 备份权益。",
          ...
          "#faq .faq-item:nth-child(7) p": "两个版本均支持 ChatGPT 和 Gemini 无限制目录导航、Markdown 与 HTML 导出，以及个人 Google Drive 备份。免费版每会话 10 个书签、每月共 20 次导出或备份操作。Pro 解锁无限书签、导出与备份，外加 Inbox AI 摘要（使用你自己的 API Key）。详见上方<a href=\"#pricing\">价格对比表</a>。",
          "#faq .faq-item:nth-child(8) h3": "Outline 会上传我的对话吗？",
          "#faq .faq-item:nth-child(8) p": "Outline 不会将对话上传到我们的服务器。如果你主动选择 Google Drive 备份，所选导出内容会通过 Google OAuth 直接上传到你自己的 Google Drive。",
