    ...
    pages: {
      ...
      "support.html": {
        ...
        selectors: {
          ".compact-hero h1": "支持",
          ".compact-hero .subtitle":
            "Wisteria Software 产品的安装、计费、激活与缺陷报告。",
          ...
          ".product-grid .product-card:nth-child(1) p:not(.product-tag)": "安装、激活、计费、退款与缺陷报告相关问题。",
          ".product-grid .product-card:nth-child(1) .btn-link": "查看 Outline",
          ".product-grid .product-card:nth-child(2) h3": "Inbox for Mac",
          ".product-grid .product-card:nth-child(2) .product-tag": "macOS",
          ".product-grid .product-card:nth-child(2) p:not(.product-tag)": "Apple Silicon Mac 上的下载、设置与本地应用问题。Windows 版本即将推出。",
          ".product-grid .product-card:nth-child(2) .btn-link": "查看 Inbox",
          ".product-grid .product-card:nth-child(3) h3": "Inbox Capture",
          ".product-grid .product-card:nth-child(3) .product-tag": "Chrome 扩展",
          ".product-grid .product-card:nth-child(3) p:not(.product-tag)": "安装、设置与浏览器伴侣相关问题。",
          ".product-grid .product-card:nth-child(3) .btn-link": "查看 Inbox",
          ".contact-box h2": "联系",
      ...
      "outline-pro.html": {
        ...
        selectors: {
          ...
          ".sales-hero h1": "ChatGPT Gemini 对话目录与大纲",
          ...
          "main > section:nth-of-type(4) h2": "还包括",
          "main > section:nth-of-type(4) .meta-card:nth-child(1)": "<strong>深色模式</strong>自动匹配你的系统偏好。",
          "main > section:nth-of-type(4) .meta-card:nth-child(2)": "<strong>键盘快捷键</strong>Alt/Option + ←/→ 切换侧边栏。",
          "main > section:nth-of-type(4) .meta-card:nth-child(3)": "<strong>灵活侧边栏</strong>左右切换，拖拽调整大小。",
          "main > section:nth-of-type(4) .meta-card:nth-child(4)": "<strong>自动刷新</strong>新消息出现或切换对话时，目录自动更新。",
          "main > section:nth-of-type(4) .meta-card:nth-child(5)": "<strong>图像感知</strong>纯图片提示会被标注，便于快速浏览。",
          "main > section:nth-of-type(4) .meta-card:nth-child(6)": "<strong>持续维护</strong>当 ChatGPT 或 Gemini 变更页面结构时，我们会及时适配，确保扩展持续可用。",
          "#faq h2": "常见问题",
